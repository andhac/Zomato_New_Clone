                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className='mt-2 flex flex-col gap-3 w-full'>
                                        <button className='py-2 justify-center rounded-lg flex items-center gap-2 w-full border border-gray-400 bg-white text-gray-400 hover:bg-gray-100' onClick={googleSignUP}>
                                        ...
                                        <form className='flex flex-col gap-2'>
                                            <div className='w-full flex flex-col'>
                                                ...
                                                <input type='text' id='fullName' value={userData.fullName}
                                                       onChange={handleChnage} placeholder='John Doe'
