    ...
    return (
        <>
            <div className='w-full mt-3 h-52 md:hidden'>
                <img src={props.images.length && props.images[0].location} alt='Restaurant' className='w-full h-full object-center object-cover rounded-lg'/>
            </div>
            <div className='hidden w-full h-96 md:flex gap-1'>
                <div className='w-full h-full overflow-hidden'>
                    <img src={props.images.length && props.images[0].location} alt='Restaurant'
                ...
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
                    <div className='w-full h-2/4 overflow-hidden '>
                        <img src={props.images.length && props.images[1].location} alt='Restaurant'
                             className=' h-full object-center object-cover rounded-lg transform transition duration-700 hover:scale-110'/>
                    </div>
                    <div className='w-full h-2/4 overflow-hidden '>
                        <img src={props.images.length && props.images[2].location} alt='Restaurant'
                         className=' h-full object-center object-cover rounded-lg transform transition duration-700 hover:scale-110'/>
                    </div>
                </div>
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
